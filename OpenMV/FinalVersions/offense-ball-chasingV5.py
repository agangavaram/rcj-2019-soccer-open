...
goalThresholds = [(66, 73, -25, 0, -50, -19)] # threshold index (yellow goal, blue goal)
ballThreshold = [(63, 96, -6, 61, 5, 29)]
...
def seeBall():
    img = sensor.snapshot()
    blobs = img.find_blobs([ballThreshold[threshold_index]], pixels_threshold=100, area_threshold=100, merge=True)
    if len(blobs) > 0:
